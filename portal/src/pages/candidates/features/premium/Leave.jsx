...
const TEMPLATES = [
  {
    ...
    description:
      "Perfect for requesting a single day off for personal or medical reasons. Concise and professional.",
...
[Designation] | [Department]`,
  },
  {
    ...
    description:
      "Formal template for extended medical leave, includes doctor certificate attachment note.",
...
[Employee ID] | [Department]`,
  },
  {
    ...
    description:
      "Comprehensive maternity leave application covering statutory rights and handover plan.",
...
[Designation] | [Department]`,
  },
  {
    ...
    description:
      "Professional resignation letter with standard notice period, suitable for all industries.",
...
[Your Name]`,
  },
  {
    ...
    description:
      "Tactful immediate resignation for urgent personal circumstances, maintains professional tone.",
...
[Your Name]`,
  },
  {
    ...
    description:
      "Data-driven cover letter template for PM roles. Highlights strategy, metrics, and cross-functional leadership.",
...
[Your Name]`,
  },
  {
    ...
    description:
      "Technical yet human cover letter for engineering roles. Balances code credibility with communication skills.",
...
[Your Name]`,
  },
  {
    ...
    description:
      "Confident, data-backed salary increment letter. Includes achievements and market benchmarking section.",
...
[Your Name]`,
  },
  {
    ...
    description:
      "Brief, respectful emergency leave application for unexpected family situations requiring immediate absence.",
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 40px 100px rgba(0,35,102,0.28), 0 0 0 1px rgba(255,255,255,0.5) inset",
        }}
      >
        {/* Modal header */}
        <div
        ...
        {/* Template text */}
        <div className="leave-modal-body" style={{ flex: 1, overflowY: "auto", padding: "28px 32px" }}>
          <pre
            style={{
              margin: 0,
        ...
        >
          ...
          <button
            onClick={() => downloadTemplateAsDoc(template)}
            style={{
              flex: 1,
              display: "flex",
              alignItems: "center",
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 22,
        border: hovered
          ? `1.5px solid ${template.accentColor}40`
          : "1.5px solid #E8EDF5",
        overflow: "hidden",
        display: "flex",
        flexDirection: "column",
...
export default function TemplatesPage() {
  ...
  return (
    ...
    >
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 1024px) {
          .leave-hero-pad { padding: 60px 30px !important; }
          .leave-grid-pad { padding: 40px 30px 80px !important; }
        }
        @media (max-width: 768px) {
          .leave-nav-inner { padding: 0 20px !important; }
          .leave-hero-pad { padding: 40px 20px 60px !important; }
          .leave-hero-flex { gap: 32px !important; }
          .leave-h1 { font-size: 36px !important; }
          .leave-search-pad { padding: 16px 20px !important; }
          .leave-grid-pad { padding: 32px 20px 80px !important; }
          .leave-grid { grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)) !important; }
          .leave-cta-pad { padding: 32px 24px !important; }
          .leave-cta-title { font-size: 20px !important; }
          .leave-modal-overlay { padding: 16px !important; }
          .leave-modal-body { padding: 20px !important; }
        }
        @media (max-width: 480px) {
          .leave-h1 { font-size: 30px !important; }
          .leave-hero-stats { gap: 20px !important; flex-wrap: wrap !important; }
          .leave-hero-stats > div > div:first-child { font-size: 20px !important; }
          .leave-cta-btns { flex-direction: column !important; width: 100% !important; }
          .leave-cta-btns > button { width: 100% !important; justify-content: center !important; }
          .leave-modal-footer { flex-direction: column !important; }
        }
      `}</style>
      ...
      {/* ── HERO ── */}
      <div className="leave-hero-pad"
        ref={heroRef}
        style={{
          backgroundImage:
            "linear-gradient(140deg, rgba(0,16,48,0.92) 0%, rgba(0,26,80,0.85) 45%, rgba(0,47,160,0.7) 100%)",
        ...
        >
          ...
          >
            ...
            <div style={{ maxWidth: 600 }}>
              ...
              >
                Professionally crafted templates for every career milestone.
                Copy, customise, and send — in minutes.
              </p>

              {/* Stats */}
              <div className="leave-hero-stats" style={{ display: "flex", gap: 32 }}>
                {[
            ...
            <div style={{ flex: 1, minWidth: 280, maxWidth: 360 }}>
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() => setPreview(featuredTemplate)}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      gap: 6,
      ...
      >
        <div className="leave-search-pad"
          style={{
            maxWidth: 1280,
            margin: "0 auto",
            padding: "16px 40px",
      ...
      {/* ── GRID ── */}
      <main className="leave-grid-pad"
        style={{ maxWidth: 1280, margin: "0 auto", padding: "48px 40px 100px" }}
      >
        {/* Results count */}
        <div
          style={{
        ...
        >
          <div style={{ fontSize: 14, fontWeight: 600, color: "#64748B" }}>
            ...
            {search && (
              <>
                {" "}
                for "<strong style={{ color: "#002366" }}>{search}</strong>"
              </>
            )}
          </div>
        ...
        {/* Bottom CTA */}
        <div className="leave-cta-pad"
          style={{
            marginTop: 64,
            padding: "48px 52px",
            background:
              "linear-gradient(135deg, #001030 0%, #001a50 50%, #002fa0 100%)",
            borderRadius: 28,
            display: "flex",
            alignItems: "center",
            justifyContent: "space-between",
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              MavenPro experts can write personalised cover letters, resignation
              letters, and more — tailored to your profile and target role.
            </p>
          </div>
          <div className="leave-cta-btns"
            style={{
              display: "flex",
              gap: 12,
              position: "relative",
