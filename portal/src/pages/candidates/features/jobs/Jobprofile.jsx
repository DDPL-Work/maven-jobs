    ...
    const fetchCompany = async () => {
      ...
      try {
        ...
        if (res?.success && res?.data) {
          ...
          const departments = Object.entries(deptMap).map(
          ...
          setCompany({
            ...
            tags: [c.type || "Private", c.industry || "Corporate"].filter(
              Boolean,
            ),
            about:
              c.about ||
              `${c.name} is a leading company in the ${c.industry || "technology"} industry, committed to excellence and innovation.`,
            mission: c.mission || "",
            vision: c.vision || "",
  ...
  const handleFollowToggle = async () => {
    ...
    try {
      ...
      setFollowersCount((prev) =>
        newFollow ? Math.max(0, prev - 1) : prev + 1,
      );
    } finally {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to bottom, rgba(0,35,102,0.15) 0%, rgba(0,35,102,0.55) 100%)",
              }}
            />
            <button
              onClick={() => navigate(-1)}
          ...
          {/* Logo + Info Row */}
          <div
            className="jp-profile-info"
            style={{ padding: "0 36px 32px", position: "relative" }}
          >
            {/* Logo */}
            <div
              className="jp-profile-logo"
              style={{
                position: "absolute",
                top: -52,
                width: 104,
                    ...
                    {company.benefits.map((ben) => (
                      <div
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.currentTarget.style.borderColor = "#CCDAFF";
                        }}
                        onMouseLeave={(e) => {
                ...
                {company.jobs
                  ...
                  .map((job) => (
                    <div
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.boxShadow =
                          "0 12px 36px rgba(10,22,40,0.11)";
                        e.currentTarget.style.borderColor = "#CCDAFF";
                      ...
                      <div>
                        <p
                          style={{
                            ...
                            lineHeight: 1.7,
                            fontWeight: 500,
                            marginBottom: expandedJobs[job.id] ? 8 : (job.desc && job.desc.length > 150 ? 4 : 18),
                            display: expandedJobs[job.id] ? "block" : "-webkit-box",
                            WebkitLineClamp: expandedJobs[job.id] ? "unset" : 2,
                        ...
                        >
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: 10,
                              border: "1.5px solid #E2E8F0",
                              background: savedJobs[job.id]
                                ? "#EEF4FF"
                                : "white",
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                              color: savedJobs[job.id] ? "#1E5EFF" : "#94A3B8",
                              cursor: "pointer",
                              transition: "all 0.18s",
                            }}
                          >
                            <FiBookmark
                              size={15}
                              style={{
                                fill: savedJobs[job.id] ? "#1E5EFF" : "none",
                              }}
                            />
                          </button>
                          <button
            ...
            {activeTab === "About" && (
              <>
                ...
                >
                  ...
                  >
                    Over the decades, Hosmac has successfully managed over 500+
                    projects across the globe, bringing together architectural
                    excellence and medical operational efficiency. Our team
                    consists of seasoned professionals dedicated to transforming
                    healthcare delivery.
                  </p>
                  <div
                    style={{
                  ...
                  {[
                    {
                      ...
                      desc: "Headquartered in Mumbai with operational footprints in Middle East and Africa.",
                      color: "#4F46E5",
                      bg: "#EEF2FF",
                      border: "#C7D2FE",
                    },
                    {
                      ...
                      desc: "ISO 9001:2015 certified consulting firm ensuring top-tier medical excellence.",
                      color: "#059669",
                      bg: "#ECFDF5",
                      border: "#A7F3D0",
                    },
                    {
                      ...
                      title: "500+ Projects",
                      desc: "Successfully delivered projects across healthcare infrastructure globally.",
                      color: "#D97706",
                      bg: "#FFFBEB",
                      border: "#FDE68A",
                    },
                    {
                      icon: <FiZap size={20} />,
                      title: "Fast-Growing",
                      desc: "Rapidly expanding team with consistent year-on-year growth since 1996.",
                      color: "#DB2777",
                      bg: "#FDF2F8",
                      border: "#FBCFE8",
                    },
                ...
                >
                  ...
                  >
                    {[
                      ...
                      {
                        label: "Website",
                        value: normalizeUrl(company.website),
                        isLink: true,
                      },
                    ].map((info) => (
                      <div
          ...
          >
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#CCDAFF";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "#EEF4FF";
                }}
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 80,
                  borderRadius: "50%",
                  background: "rgba(13,191,123,0.15)",
                }}
              />
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                >
                  Explore all openings and apply with your Maven profile
                  instantly.
                </p>
                <button
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = "#0DBF7B";
                    e.currentTarget.style.transform = "none";
                  }}
                >
                    ...
                    try {
                      ...
                      const res = await authService.submitCompanyReview(id, {
                        ...
                        candidateName:
                          ...
                          "Candidate",
                        candidateTitle:
                          savedUser.headline || savedUser.title || "Candidate",
                      });
                      ...
                      <div>
                        <p
                          style={{
                            ...
                            lineHeight: 1.65,
                            fontWeight: 500,
                            marginBottom: expandedJobs[job.id] ? 8 : (job.desc && job.desc.length > 150 ? 4 : 14),
                            display: expandedJobs[job.id] ? "block" : "-webkit-box",
                            WebkitLineClamp: expandedJobs[job.id] ? "unset" : 2,
                            WebkitBoxOrient: "vertical",
                            overflow: "hidden",
